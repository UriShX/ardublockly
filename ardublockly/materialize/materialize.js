    ...
    a.fn.dropdown = function(b) {
        ...
        this.each(function() {
            ...
            function e(b) {
                ...
                var o = 0
                  , p = g.parent();
                if (!p.is("body") && p[0].scrollHeight > p[0].clientHeight && (o = p[0].scrollTop),
...
!function(e) {
    ...
    e.fn.extend({
        openModal: function(t) {
            ...
            var i = {
              ...
              , n = e(this)
              , c = ++o;
            return "block" == n.css("display") ? (associatedOverlayID = n.data("overlay-id"),
            $associatedOverlay = e("#" + associatedOverlayID),
            $associatedOverlay.css("z-index", 1e3 + 2 * c),
            void n.css("z-index", 1e3 + 2 * c + 1)) : (overlayID = a(),
            $overlay = e('<div class="lean-overlay"></div>'),
            $overlay.attr("id", overlayID).css("z-index", 1e3 + 2 * c),
            n.data("overlay-id", overlayID).css("z-index", 1e3 + 2 * c + 1),
            e("body").append($overlay),
            t = e.extend(i, t),
            t.dismissible && ($overlay.click(function() {
                n.closeModal(t)
            }),
            ...
            n.data("associated-overlay", $overlay[0]),
            void (n.hasClass("bottom-sheet") ? n.velocity({
                bottom: "0",
                opacity: 1
            }, {
                duration: t.in_duration,
    ...
    e.fn.extend({
        closeModal: function(t) {
            ...
            t = e.extend(a, t),
            e("body").css("overflow", ""),
            i.find(".modal-close").off("click.close"),
            e(document).off("keyup.leanModal" + n),
            c.velocity({
                opacity: 0
            }, {
